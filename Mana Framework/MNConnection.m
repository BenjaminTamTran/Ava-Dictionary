...
@implementation MNConnection
static void ReachabilityCallback(SCNetworkReachabilityRef target, SCNetworkReachabilityFlags flags, void* info)
{
#pragma unused (target, flags)
	NSCAssert(info != NULL, @"info was NULL in ReachabilityCallback");
	NSCAssert([(NSObject*) info isKindOfClass: [MNConnection class]], @"info was wrong class in ReachabilityCallback");
    
	
	NSAutoreleasePool* myPool = [[NSAutoreleasePool alloc] init];
	
	MNConnection* noteObject = (MNConnection*) info;
...
+ (MNConnection*) reachabilityForLocalWiFi;
{
	...
	MNConnection* retVal = [self reachabilityWithAddress: &localWifiAddress];
	if(retVal!= NULL)
	{
